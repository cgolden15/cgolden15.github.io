...
:root {
  ...
  --color-border-active: #007BFF;
  --color-border-default: #d1d1d1;
  --color-highlight: #fdcf4c;
  --color-primary: #007BFF;
  --color-primary-active:rgb(6, 80, 158);
  --color-text-default:rgb(238, 236, 236);
...
***
<br>
<h3 style="text-align:center;">In the meantime, contact me! </h3>
<form
  action="https://formspree.io/f/mrbearba"
  class="fs-form"
  target="_top"
  method="POST"
>
